...
from train_td3_hrsga_ball import load_agent_from_checkpoint


BALL_COLORS = ["tab:blue", "tab:orange", "tab:green", "tab:red", "tab:brown", "tab:pink"]


def test_td3_hrsga_ball(model_path, num_tests=5, max_steps=None, plot_path="td3_hrsga_eval.png", show_plot=False, seed=5300, layout_mode="representative"):
    ...
    for test_idx in range(num_tests):
        ...
        all_runs.append({"trajectories": [np.asarray(traj, dtype=np.float32) for traj in trajectories], "snapshot": snapshot})
