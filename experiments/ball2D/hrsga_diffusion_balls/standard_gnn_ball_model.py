...
class StandardGNNBallAgent:
    def __init__(self, num_balls, max_steps, num_tasks=None, hidden_dim=128, edge_hidden_dim=64, device=None):
...
def evaluate_agent(agent, num_episodes=10, num_balls=None, num_tasks=None, max_steps=None, base_seed=5300):
