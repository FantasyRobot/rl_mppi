...
def compare_models(
    ...
    for test_idx in range(num_tests):
        ...
        left_run = run_episode(left_model_type, left_agent, run_seed, max_steps=max_steps, layout_mode=layout_mode, strict_collision_stop=strict_collision_stop, num_balls=num_balls, num_tasks=num_tasks)
        right_run = run_episode(right_model_type, right_agent, run_seed, max_steps=max_steps, layout_mode=layout_mode, strict_collision_stop=strict_collision_stop, num_balls=num_balls, num_tasks=num_tasks)
