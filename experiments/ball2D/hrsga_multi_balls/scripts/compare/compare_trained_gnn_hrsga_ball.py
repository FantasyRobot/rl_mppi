...
def rollout(agent, seed, max_steps=None, layout_mode="representative", num_balls=None, num_tasks=None):
...
def compare_models(
    ...
    for test_idx in range(num_tests):
        ...
        gnn_run = rollout(gnn_agent, seed=run_seed, max_steps=max_steps, layout_mode=layout_mode, num_balls=num_balls, num_tasks=num_tasks)
        hrsga_run = rollout(hrsga_agent, seed=run_seed, max_steps=max_steps, layout_mode=layout_mode, num_balls=num_balls, num_tasks=num_tasks)
        comparisons.append(
            {
                "seed": int(run_seed),
                "standard_gnn": {
