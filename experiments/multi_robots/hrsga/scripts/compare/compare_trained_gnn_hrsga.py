...
def rollout(agent, seed, max_steps=None, layout_mode="representative", enforce_visit_order=True, xml_path=None):
...
def main():
    ...
    parser.add_argument("--hrsga_model_path", type=str, default=os.path.join(ROOT_DIR, "models", "hrsga_best.pt"))
    parser.add_argument("--gnn_model_path", type=str, default=os.path.join(ROOT_DIR, "models", "standard_gnn_best.pt"))
