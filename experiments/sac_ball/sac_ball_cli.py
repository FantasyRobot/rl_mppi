...
def _parse_args() -> argparse.Namespace:
    ...
    p_test.add_argument("--plot_path", type=str, default=os.path.join(_RESULTS_DIR, "ball_trajectories_sac.png"))
    ...
    p_test_near = sub.add_parser(
        "test_near",
        help="Convenience test: init near target (radius=1) and save plot to experiments/results/",
    )
    ...
    p_test_near.add_argument("--plot_path", type=str, default=os.path.join(_RESULTS_DIR, "ball_trajectories_sac_near.png"))
...
def _run_default() -> None:
    ...
    saves a trajectory plot under experiments/results/.
    """
    target = Target(x=3.0, y=3.0)
    save_path = "models/sac_ball_model_online.pth"
    plot_path = os.path.join(_RESULTS_DIR, "ball_trajectories_sac_default.png")
