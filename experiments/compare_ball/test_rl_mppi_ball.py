...
def test_rl_mppi_ball(
    *,
    ...
    for test_idx in range(num_tests):
        ...
        while True:
            # If already within reach threshold, stop without extra controller compute.
...
def main() -> None:
    ...
    parser.add_argument(
        "--plot_path",
        type=str,
        default=os.path.join(_ROOT_DIR, "experiments", "results", "ball_trajectories_rl_mppi.png"),
    )
